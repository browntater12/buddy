...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.black, actions: [IconButton(onPressed: (){print("settings");}, icon: Icon(Icons.settings, color: colors.iconColor))], centerTitle: false, title: Text("Torque", style: TextStyle(color: Color.fromRGBO(247, 247, 255, 1), fontWeight: FontWeight.bold),)),
      body: Column(
          children: [
            TorqueOutput(),
          ...
          bottomNavigationBar: Material(
            ...
            child: Row(
              ...
              children: [
              IconButton(onPressed: (){print("save");}, icon: Icon(Icons.bookmark_add_outlined, size: 30,), color: colors.iconColor,),
              IconButton(onPressed: (){print("list");}, icon: Icon(Icons.list_alt_outlined, size: 30,), color: colors.iconColor),
              IconButton(onPressed: (){print("list");}, icon: Icon(Icons.shopping_cart_outlined, size: 30,), color: colors.iconColor),
            ],),
                    )
                  ),
          ),
